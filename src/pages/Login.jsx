          ...
          <div className="flex-1 lg:w-1/2 flex items-start lg:items-center justify-center px-6 pb-8 lg:p-12">
            <Card className="w-full max-w-md bg-white/98 backdrop-blur-2xl shadow-2xl border-0 rounded-3xl overflow-hidden transform lg:translate-y-0 -translate-y-8">
              ...
              <Button
                ...
                className="w-full mb-6 h-14 bg-white border-2 border-gray-200 hover:border-blue-300 hover:bg-blue-50/50 text-gray-700 font-semibold shadow-lg hover:shadow-xl transition-all duration-300 group disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {googleLoading ? (
              ...
              <div className="mt-8 text-center space-y-2">
                <p className="text-gray-600 text-sm">
                  ...
                  <Link to="/signup" className="text-blue-600 hover:text-blue-700 font-bold transition-colors hover:underline">
                    Create account
                  </Link>
                </p>
                <p className="text-gray-500 text-xs">
                  <Link to="/profile-setup" className="text-orange-600 hover:text-orange-700 font-medium transition-colors hover:underline">
                    Go to Profile Setup
                  </Link>
                </p>
              </div>
